...
Предположим, что в среднем 1/3 запросов является популярной и кешируется. И принимая во внимание таблицу выше, получим следующие значения:
...
-------------------|--------------|--------------|---------
 ...
 ElasticSearch     | 750 Тб       | 30 000       |п
 YTsaurus          | 150 Пб       | 30 000       | 

__Конфигурация серверов__

 Сервис |	Хостинг |	Конфигурация |	Cores |	N |	Покупка
--------|---------|--------------|--------|---|---------
